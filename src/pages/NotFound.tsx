  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4  pt-28">
        ...
        <Link
          to="/"
          className="mt-6 inline-flex items-center gap-2 px-6 py-3 bg-gray-800 text-white dark:bg-gray-600 text-lg font-semibold rounded-lg shadow-md hover:bg-blue-700 transition-all"
        >
