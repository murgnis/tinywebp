  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 flex flex-col">
      ...
      <div className="flex-1 max-w-3xl mx-auto px-6 py-12 text-gray-800 dark:text-gray-300 pt-28">
        ...
        <p className="mb-4">
          Welcome to <strong>TinyWebP</strong> (tinywebp.isuru.info). By accessing and using this website, you agree to the following terms and conditions. If you do not agree, please discontinue use immediately.
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">1. Use of the Service</h2>
        <ul className="list-disc pl-6">
          <li>TinyWebP is a free web-based tool for compressing images.</li>
        ...
        <ul className="list-disc pl-6">
          ...
          <li>TinyWebP does not upload, store, or collect any images you process.</li>
        ...
        <ul className="list-disc pl-6">
          ...
          <li>TinyWebP is provided as a free tool with no warranties. Use at your own risk.</li>
        </ul>
